...
public final class Client extends GameShell implements Usernamed {
	...
	protected final void resizeGame() {
		field868 = DirectByteArrayCopier.currentTimeMillis() + 500L;
		this.resizeJS();
		if (rootInterface != -1) {
	...
	protected final void setUp() {
		...
		WorldMapLabelSize.clientPreferences = ModelData0.method3249();
		this.setUpClipboard();
		...
		while (true) {
			...
			if (var1 == null) {
				...
				try {
					if (class197.field2402 == 1) {
						...
						if (var6 > 0 && Interpreter.midiPcmStream.isReady()) {
							...
							Interpreter.midiPcmStream.setPcmStreamVolume(var6);
						} else {
				...
				if (gameState == 0) {
					...
					VarbitDefinition.doCycleTitle(this);
					Timer.load();
					WallDecoration.method3291();
	...
	protected final void draw(boolean var1) {
			...
			try {
				if (class197.field2402 == 2) {
					...
					if (Interpreter.midiPcmStream.loadMusicTrack(UserComparator10.musicTrack, class197.musicPatchesArchive, WorldMapLabelSize.soundCache, 22050)) {
						...
						Interpreter.midiPcmStream.setPcmStreamVolume(ScriptFrame.musicTrackVolume);
		...
		if ((gameState == 10 || gameState == 20 || gameState == 30) && field868 != 0L && DirectByteArrayCopier.currentTimeMillis() > field868) {
	...
	public final void init() {
		try {
			if (this.checkHost()) {
				class271[] var1 = FaceNormal.method3265();

				for (int var2 = 0; var2 < var1.length; ++var2) {
					class271 var3 = var1[var2];
					String var4 = this.getParameter(var3.field3597);
					if (var4 != null) {
						switch(Integer.parseInt(var3.field3597)) {
						case 1:
						...
						case 6:
							...
							break;
						case 7:
							PacketBufferNode.field2337 = ServerBuild.method4133(Integer.parseInt(var4));
							break;
						case 8:
							if (var4.equalsIgnoreCase("true")) {
							}
						...
						case 10:
							...
							if (WorldMapRegion.field248 == StudioGame.oldscape) {
				...
				try {
					...
					if (js5ConnectState == 2) {
						if (useBufferedSocket) {
							HealthBarUpdate.js5Socket = BZip2State.method5770((Socket)class191.js5SocketTask.result, 40000, 5000);
						} else {
						...
						++js5ConnectState;
						class192.field2382 = DirectByteArrayCopier.currentTimeMillis();
					}
					...
					if (js5ConnectState == 3) {
						if (HealthBarUpdate.js5Socket.available() > 0 || !useBufferedSocket && gameState <= 5) {
							...
							++js5ConnectState;
						} else if (DirectByteArrayCopier.currentTimeMillis() - class192.field2382 > 30000L) {
							this.js5Error(-2);
							return;
						}
					}
		...
		try {
			...
			if (loginState == 1) {
				...
				if (Ignored.socketTask.status == 1) {
					if (useBufferedSocket) {
						var1 = BZip2State.method5770((Socket)Ignored.socketTask.result, 40000, 5000);
					} else {
		...
		if (field701) {
			...
			if (gameState == 30) {
				...
				while (MidiPcmStream.method3811()) {
					var15 = Archive.getPacketBufferNode(ClientPacket.field2252, packetWriter.isaacCipher);
				...
				if (timer.field3605) {
					var15 = Archive.getPacketBufferNode(ClientPacket.field2217, packetWriter.isaacCipher);
					var15.packetBuffer.writeByte(0);
					var2 = var15.packetBuffer.offset;
				...
				if (MouseHandler.MouseHandler_lastButton == 1 || !DevicePcmPlayerProvider.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) {
					long var17 = (MouseHandler.MouseHandler_lastPressedTimeMillis - mouseLastLastPressedTimeMillis) / 50L;
					if (var17 > 4095L) {
						var17 = 4095L;
					}
					...
					var5 = (int)var17;
					var19 = Archive.getPacketBufferNode(ClientPacket.field2234, packetWriter.isaacCipher);
				...
				if (KeyHandler.field386 > 0) {
					var15 = Archive.getPacketBufferNode(ClientPacket.field2270, packetWriter.isaacCipher);
					var15.packetBuffer.writeShort(0);
					var2 = var15.packetBuffer.offset;
					long var20 = DirectByteArrayCopier.currentTimeMillis();
					...
					for (var5 = 0; var5 < KeyHandler.field386; ++var5) {
						...
						field879 = var20;
						var15.packetBuffer.writeIntME(KeyHandler.field401[var5]);
				...
				if (field878 && field822 <= 0) {
					field822 = 20;
					field878 = false;
					var15 = Archive.getPacketBufferNode(ClientPacket.field2242, packetWriter.isaacCipher);
					var15.packetBuffer.method5475(camAngleX);
					var15.packetBuffer.method5634(camAngleY);
					packetWriter.addNode(var15);
				}

				if (class267.hasFocus && !hadFocus) {
					hadFocus = true;
					var15 = Archive.getPacketBufferNode(ClientPacket.field2276, packetWriter.isaacCipher);
				...
				int[] var37;
				if (field747 != class42.Client_plane) {
					field747 = class42.Client_plane;
					var1 = class42.Client_plane;
					...
					for (var6 = 0; var6 < 104; ++var6) {
						for (var7 = 0; var7 < 104; ++var7) {
							long var24 = GrandExchangeOfferWorldComparator.scene.getFloorDecorationTag(class42.Client_plane, var6, var7);
							if (0L != var24) {
								var10 = class43.Entity_unpackID(var24);
				...
				if (gameState == 30) {
					...
					if (packetWriter.field1318 > 750) {
						...
						for (var3 = 0; var3 < var1; ++var3) {
							...
							if (var26 != null) {
								StructDefinition.method4531(var26, 1);
							}
						}
						...
						while (class218.isKeyDown() && field754 < 128) {
							if (staffModLevel >= 2 && KeyHandler.KeyHandler_pressedKeys[82] && ReflectionCheck.field1338 == 66) {
								String var27 = UrlRequester.method3305();
						...
						if (var33 && KeyHandler.KeyHandler_pressedKeys[82] && KeyHandler.KeyHandler_pressedKeys[81] && mouseWheelRotation != 0) {
							...
							if (var4 != localPlayer.plane) {
								WorldMapLabel.method418(localPlayer.pathX[0] + MusicPatchNode2.baseX, localPlayer.pathY[0] + class1.baseY, var4, false);
							}
													...
													do {
														...
														if (var41 == null) {
																...
																if (MouseHandler.MouseHandler_currentButton == 0) {
																	if (field874) {
																		if (class294.field3697 == WorldMapIcon_0.dragInventoryWidget && dragItemSlotDestination != dragItemSlotSource) {
																			...
																			var19 = Archive.getPacketBufferNode(ClientPacket.field2283, packetWriter.isaacCipher);
																			var19.packetBuffer.writeShort(dragItemSlotDestination);
																			var19.packetBuffer.method5634(dragItemSlotSource);
																			var19.packetBuffer.writeInt(WorldMapIcon_0.dragInventoryWidget.id);
																			var19.packetBuffer.writeIntME(var34);
																			packetWriter.addNode(var19);
																		}
																		...
																		Messages.menuAction(var40.param0, var40.param1, var40.opcode, var40.identifier, var40.action, var40.action, var4, var5);
																		tempMenuAction = null;
																	}
															...
															if (Scene.method3105()) {
																...
																var19 = Archive.getPacketBufferNode(ClientPacket.field2299, packetWriter.isaacCipher);
																var19.packetBuffer.writeByte(5);
																var19.packetBuffer.method5530(var5 + class1.baseY);
																var19.packetBuffer.method5530(var4 + MusicPatchNode2.baseX);
															...
															class80.method1982();
															if (isCameraLocked) {
																var4 = DevicePcmPlayerProvider.field412 * 128 + 64;
																var5 = class210.field2516 * 128 + 64;
																var6 = ScriptEvent.getTileHeight(var4, var5, class42.Client_plane) - Language.field2345;
																...
																var4 = HealthBarUpdate.field1017 * 128 + 64;
																var5 = class30.field259 * 128 + 64;
																var6 = ScriptEvent.getTileHeight(var4, var5, class42.Client_plane) - WorldMapID.field268;
	...
	final void drawLoggedIn() {
		...
		if (showMouseCross) {
			if (mouseCrossColor == 1) {
				Occluder.crossSprites[mouseCrossState / 100].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}

			if (mouseCrossColor == 2) {
				Occluder.crossSprites[mouseCrossState / 100 + 4].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}
		}
		...
		if (!isMenuOpen) {
			if (viewportX != -1) {
				WorldMapSprite.method412(viewportX, viewportY);
			}
		} else {
			var1 = class247.menuX;
			var2 = class30.menuY;
		...
		for (ObjectSound var5 = (ObjectSound)ObjectSound.objectSounds.last(); var5 != null; var5 = (ObjectSound)ObjectSound.objectSounds.previous()) {
			if (var5.soundEffectId != -1 || var5.soundEffectIds != null) {
				var6 = 0;
				if (var2 > var5.field1077) {
					var6 += var2 - var5.field1077;
				} else if (var2 < var5.x) {
					var6 += var5.x - var2;
				}

				if (var3 > var5.field1082) {
					var6 += var3 - var5.field1082;
				} else if (var3 < var5.y) {
					var6 += var5.y - var3;
				}

				if (var6 - 64 <= var5.field1091 && areaSoundEffectVolume != 0 && var1 == var5.plane) {
					var6 -= 64;
					if (var6 < 0) {
						var6 = 0;
					}

					var7 = (var5.field1091 - var6) * areaSoundEffectVolume / var5.field1091;
					Object var10000;
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field2200 == var1.serverPacket) {
					...
					SoundCache.forceDisconnect(var16);
					var1.serverPacket = null;
					return false;
				}
				...
				if (ServerPacket.field2168 == var1.serverPacket) {
					...
					GrandExchangeOfferUnitPriceComparator.changeGameOptions(var5);
				...
				if (ServerPacket.field2179 == var1.serverPacket) {
					DefaultsGroup.field3819 = var3.method5524();
				...
				if (ServerPacket.field2161 == var1.serverPacket) {
					...
					changedItemContainers[++field671 - 1 & 31] = var16 & 32767;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field2198 == var1.serverPacket) {
					isCameraLocked = true;
					HealthBarUpdate.field1017 = var3.readUnsignedByte();
					class30.field259 = var3.readUnsignedByte();
					...
					if (Tiles.field501 >= 100) {
						var16 = HealthBarUpdate.field1017 * 128 + 64;
						var5 = class30.field259 * 128 + 64;
						var17 = ScriptEvent.getTileHeight(var16, var5, class42.Client_plane) - WorldMapID.field268;
				...
				if (ServerPacket.field2142 == var1.serverPacket) {
					...
					if (!var49 && field767 == 0) {
						...
						if (var11.modIcon != -1) {
							class14.addChatMessage(9, WorldMapSection1.method556(var11.modIcon) + var37, var27, class215.base37DecodeLong(var23));
						} else {
				...
				if (ServerPacket.field2121 == var1.serverPacket) {
					isCameraLocked = true;
					DevicePcmPlayerProvider.field412 = var3.readUnsignedByte();
					class210.field2516 = var3.readUnsignedByte();
					...
					if (class96.field1327 >= 100) {
						PacketBuffer.cameraX = DevicePcmPlayerProvider.field412 * 128 + 64;
						class1.cameraZ = class210.field2516 * 128 + 64;
						class43.cameraY = ScriptEvent.getTileHeight(PacketBuffer.cameraX, class1.cameraZ, class42.Client_plane) - Language.field2345;
					}
				...
				if (ServerPacket.field2188 == var1.serverPacket) {
					for (var16 = 0; var16 < Varps.Varps_main.length; ++var16) {
						if (Varps.Varps_temp[var16] != Varps.Varps_main[var16]) {
							...
							GrandExchangeOfferUnitPriceComparator.changeGameOptions(var16);
				...
				if (ServerPacket.field2140 == var1.serverPacket) {
					ChatChannel.field1306 = var3.method5524();
					...
					for (var16 = DefaultsGroup.field3819; var16 < DefaultsGroup.field3819 + 8; ++var16) {
						for (var5 = ChatChannel.field1306; var5 < ChatChannel.field1306 + 8; ++var5) {
							if (groundItems[class42.Client_plane][var16][var5] != null) {
								groundItems[class42.Client_plane][var16][var5] = null;
					...
					for (PendingSpawn var38 = (PendingSpawn)pendingSpawns.last(); var38 != null; var38 = (PendingSpawn)pendingSpawns.previous()) {
						if (var38.x >= DefaultsGroup.field3819 && var38.x < DefaultsGroup.field3819 + 8 && var38.y >= ChatChannel.field1306 && var38.y < ChatChannel.field1306 + 8 && var38.plane == class42.Client_plane) {
							var38.hitpoints = 0;
						}
					}
				...
				if (ServerPacket.field2193 == var1.serverPacket) {
					for (var16 = 0; var16 < VarpDefinition.VarpDefinition_fileCount; ++var16) {
						VarpDefinition var51 = GrandExchangeOfferWorldComparator.VarpDefinition_get(var16);
						if (var51 != null) {
				...
				if (ServerPacket.field2185 == var1.serverPacket) {
					...
					class65.method1176();
					changedItemContainers[++field671 - 1 & 31] = var5 & 32767;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field2195 == var1.serverPacket) {
					tradeChatMode = var3.method5524();
					publicChatMode = var3.method5524();
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field2135 == var1.serverPacket) {
					...
					if (var50) {
						Buddy.field3632 = DirectByteArrayCopier.currentTimeMillis() - var3.readLong();
				...
				if (ServerPacket.field2141 == var1.serverPacket) {
					...
					if (!var33 && field767 == 0) {
						...
						if (var30.modIcon != -1) {
							ScriptEvent.addGameMessage(var14, WorldMapSection1.method556(var30.modIcon) + var37, var34);
						} else {
				...
				HitSplatDefinition.RunException_sendStackTrace("" + (var1.serverPacket != null ? var1.serverPacket.id * 446261051 * 495376883 : -1) + "," + (var1.field1321 != null ? var1.field1321.id * 446261051 * 495376883 : -1) + "," + (var1.field1317 != null ? var1.field1317.id * 446261051 * 495376883 : -1) + "," + var1.serverPacketLength, (Throwable)null);
				RouteStrategy.logOut();
			} catch (IOException var35) {
				ScriptFrame.method1090();
			} catch (Exception var36) {
				var18 = "" + (var1.serverPacket != null ? var1.serverPacket.id * 446261051 * 495376883 : -1) + "," + (var1.field1321 != null ? var1.field1321.id * 446261051 * 495376883 : -1) + "," + (var1.field1317 != null ? var1.field1317.id * 446261051 * 495376883 : -1) + "," + var1.serverPacketLength + "," + (localPlayer.pathX[0] + MusicPatchNode2.baseX) + "," + (localPlayer.pathY[0] + class1.baseY) + ",";
			...
			if (clickedWidget == null) {
				...
				if (isMenuOpen) {
					...
					if (WorldMapIcon_0.dragInventoryWidget != null && !field874 && menuOptionsCount > 0 && !this.shouldLeftClickOpenMenu()) {
						...
						Messages.menuAction(var11.param0, var11.param1, var11.opcode, var11.identifier, var11.action, var11.action, var9, var10);
						tempMenuAction = null;
					}
	...
	final boolean shouldLeftClickOpenMenu() {
		...
		return (leftClickOpensMenu == 1 && menuOptionsCount > 2 || Interpreter.method1936(var1)) && !menuShiftClick[var1];
	}
	...
	final void openMenu(int var1, int var2) {
		...
		GrandExchangeOfferWorldComparator.scene.menuOpen(class42.Client_plane, var1, var2, false);
		isMenuOpen = true;
	}
				...
				if (isDraggingWidget) {
					...
					if (draggedOnWidget != null) {
						...
						if (var15 != null) {
							...
							var16.packetBuffer.method5538(clickedWidget.id);
							var16.packetBuffer.method5539(draggedOnWidget.id);
					...
					Messages.menuAction(var12.param0, var12.param1, var12.opcode, var12.identifier, var12.action, var12.action, var13, var14);
					tempMenuAction = null;
				}
