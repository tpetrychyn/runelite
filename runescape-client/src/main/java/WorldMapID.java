...
public class WorldMapID {
		...
		if (var0 == ScriptOpcodes.CLIENTCLOCK) {
			...
			if (var0 == ScriptOpcodes.INV_GETOBJ) {
				...
				if (var0 == ScriptOpcodes.COORD) {
					var3 = class42.Client_plane;
					var4 = (Client.localPlayer.x >> 7) + MusicPatchNode2.baseX;
					var5 = (Client.localPlayer.y >> 7) + class1.baseY;
	...
	static void Widget_runOnTargetLeave() {
		if (Client.isSpellSelected) {
			Widget var0 = Client.getWidgetChild(WorldMapEvent.selectedSpellWidget, Client.selectedSpellChildIndex);
