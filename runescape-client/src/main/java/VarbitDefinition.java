...
public class VarbitDefinition extends DualNode {
	...
	public static int method4493(CharSequence var0, int var1) {
		...
		if (Login.worldSelectOpen) {
			...
			if (Client.gameState != 5) {
				if (Login.field1193 == -1L) {
					Login.field1193 = DirectByteArrayCopier.currentTimeMillis() + 1000L;
				}

				long var11 = DirectByteArrayCopier.currentTimeMillis();
					...
					if (Login.loginIndex == 0) {
						...
						if (var3 == 1 && var15 >= var7 - 75 && var15 <= var7 + 75 && var16 >= var8 - 20 && var16 <= var8 + 20 || var17) {
							if ((Client.worldProperties & 33554432) != 0) {
								...
								FaceNormal.Login_promptCredentials(false);
							}
						}
					} else {
						int var18;
						...
						if (Login.loginIndex != 1) {
							...
							if (Login.loginIndex == 2) {
								...
								if (Login.loginIndex == 4) {
									...
									var18 = Login.loginBoxX + 180 + 80;
									if (var3 == 1 && var15 >= var18 - 75 && var15 <= var18 + 75 && var16 >= var20 - 20 && var16 <= var20 + 20) {
										FaceNormal.Login_promptCredentials(true);
									}
