			...
			if (var4 >= 0) {
				...
				if (var6 == 22) {
					...
					if (var6 >= 12) {
						...
						var42.newGameOjbect(var0, var2, var3, var23, 1, 1, (Renderable)var29, 0, var26, var28);
					...
					if (var29 != null) {
						var42.newGameOjbect(var0, var2, var3, var23, var16, var17, (Renderable)var29, var6 == 11 ? 256 : 0, var26, var28);
					}
