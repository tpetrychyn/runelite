...
public class StructDefinition extends DualNode {
	...
	static final void method4531(Actor var0, int var1) {
		int var2;
		int var3;
		int var4;
		...
		if (var0.field995 > Client.cycle) {
			...
			var3 = var0.field952 * 64 + var0.field991 * 128;
			var4 = var0.field952 * 64 + var0.field993 * 128;
			...
			if (var0.field996 >= Client.cycle) {
				if (var0.field996 == Client.cycle || var0.sequence == -1 || var0.sequenceDelay != 0 || var0.sequenceFrameCycle + 1 > GrandExchangeEvent.SequenceDefinition_get(var0.sequence).frameLengths[var0.sequenceFrame]) {
					...
					var4 = var0.field952 * 64 + var0.field991 * 128;
					var5 = var0.field952 * 64 + var0.field993 * 128;
					int var6 = var0.field952 * 64 + var0.field992 * 128;
					var7 = var0.field952 * 64 + var0.field983 * 128;
				...
				if (var0.pathLength == 0) {
					...
					label434: {
						...
						var2 = var0.x;
						var3 = var0.y;
						var4 = var0.field952 * 64 + var0.pathX[var0.pathLength - 1] * 128;
						var5 = var0.field952 * 64 + var0.pathY[var0.pathLength - 1] * 128;
						if (var2 < var4) {
							if (var3 < var5) {
		...
		if (var0.x < 128 || var0.y < 128 || var0.x >= 13184 || var0.y >= 13184) {
			...
			var0.field995 = 0;
			var0.field996 = 0;
			var0.x = var0.pathX[0] * 128 + var0.field952 * 64;
			var0.y = var0.field952 * 64 + var0.pathY[0] * 128;
			var0.method1658();
		}
		...
		if (Client.localPlayer == var0 && (var0.x < 1536 || var0.y < 1536 || var0.x >= 11776 || var0.y >= 11776)) {
			...
			var0.field995 = 0;
			var0.field996 = 0;
			var0.x = var0.field952 * 64 + var0.pathX[0] * 128;
			var0.y = var0.pathY[0] * 128 + var0.field952 * 64;
			var0.method1658();
		}
