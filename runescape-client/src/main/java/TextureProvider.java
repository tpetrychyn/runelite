	...
	static File method2760(String var0, String var1, int var2) {
		...
		if (var4 == null && var2 == 0) {
			...
			for (int var15 = 0; var15 < LoginPacket.field2309.length; ++var15) {
				for (int var16 = 0; var16 < JagexCache.field2043.length; ++var16) {
					File var17 = new File(JagexCache.field2043[var16] + LoginPacket.field2309[var15] + File.separatorChar + var0 + File.separatorChar);
