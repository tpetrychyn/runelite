...
public class ArchiveLoader {
	...
	public static boolean method1094(AbstractArchive var0, AbstractArchive var1, AbstractArchive var2, MidiPcmStream var3) {
			...
			if (Client.minimapState != 2 && Client.minimapState != 5) {
				...
				for (var8 = 0; var8 < 104; ++var8) {
					for (var9 = 0; var9 < 104; ++var9) {
						NodeDeque var15 = Client.groundItems[class42.Client_plane][var8][var9];
						if (var15 != null) {
				...
				if (Client.hintArrowType != 0 && Client.cycle % 20 < 10) {
					...
					if (Client.hintArrowType == 2) {
						var10 = Client.hintArrowX * 4 - MusicPatchNode2.baseX * 4 + 2 - Client.localPlayer.x / 32;
						var11 = Client.hintArrowY * 4 - class1.baseY * 4 + 2 - Client.localPlayer.y / 32;
