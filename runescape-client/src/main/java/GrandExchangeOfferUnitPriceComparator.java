...
final class GrandExchangeOfferUnitPriceComparator implements Comparator {
	...
	static final void changeGameOptions(int var0) {
		...
		int var4 = GrandExchangeOfferWorldComparator.VarpDefinition_get(var0).type;
		if (var4 != 0) {
			...
			if (var4 == 3) {
				...
				if (var3 != Client.musicVolume) {
					if (Client.musicVolume == 0 && Client.currentTrackGroupId != -1) {
						FileSystem.method3503(WorldMapRegion.archive6, Client.currentTrackGroupId, 0, var3, false);
						...
						Interpreter.midiPcmStream.setPcmStreamVolume(var3);
					}
