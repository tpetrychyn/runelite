	...
	static void readPlayerUpdate(PacketBuffer var0, int var1) {
		...
		if (var3 == 0) {
			if (var2) {
				...
				Players.Players_regions[var1] = (var4.plane << 28) + (class1.baseY + var4.pathY[0] >> 13) + (MusicPatchNode2.baseX + var4.pathX[0] >> 13 << 14);
				if (var4.field976 != -1) {
			...
			if (var3 == 1) {
				...
				if (var5 == 0) {
					...
					if (Client.localPlayerIndex == var1) {
						class42.Client_plane = var4.plane;
					}
					...
					var8 = var6 >> 14 & 16383;
					var9 = var6 & 16383;
					var10 = (var8 + MusicPatchNode2.baseX + var4.pathX[0] & 16383) - MusicPatchNode2.baseX;
					var11 = (var9 + class1.baseY + var4.pathY[0] & 16383) - class1.baseY;
					if (Client.localPlayerIndex == var1 && (var4.x < 1536 || var4.y < 1536 || var4.x >= 11776 || var4.y >= 11776)) {
						var4.resetPath(var10, var11);
						var4.field638 = false;
					} else if (var2) {
		...
		if (Client.minimapState == 0 || Client.minimapState == 3) {
			if (!Client.isMenuOpen && (MouseHandler.MouseHandler_lastButton == 1 || !DevicePcmPlayerProvider.mouseCam && MouseHandler.MouseHandler_lastButton == 4)) {
				...
				if (var3.contains(var4, var5)) {
					...
					var13.packetBuffer.method5530(var12 + class1.baseY);
					var13.packetBuffer.method5530(var11 + MusicPatchNode2.baseX);
