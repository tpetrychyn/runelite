...
public class Timer {
	...
	public void method5005() {
		this.field3603 = DirectByteArrayCopier.currentTimeMillis();
	}
	...
	public void method4993() {
		if (this.field3603 != -1L) {
			this.field3604 = DirectByteArrayCopier.currentTimeMillis() - this.field3603;
			this.field3603 = -1L;
		}
	...
	public void method4996(int var1) {
		this.field3602 = DirectByteArrayCopier.currentTimeMillis();
		this.field3608 = var1;
	}
	...
	public void method5014() {
		if (-1L != this.field3602) {
			this.field3607 = DirectByteArrayCopier.currentTimeMillis() - this.field3602;
			this.field3602 = -1L;
		}
	...
	static void load() {
		...
		if (Client.titleLoadingStage == 0) {
			...
			ArchiveLoader.method1094(GrandExchangeOfferOwnWorldComparator.archive15, Tile.archive14, class13.archive4, var33);
			...
			AttackOption.decimator = new Decimator(22050, CollisionMap.field2078);
			...
			if (Client.titleLoadingStage == 50) {
				...
				if (Client.titleLoadingStage == 60) {
					...
					if (!class215.archive2.isFullyLoaded()) {
						...
						WorldMapSprite.method414(class215.archive2);
						...
						FaceNormal.method3263(class215.archive2, NPCDefinition.archive7);
						...
						GrandExchangeOfferWorldComparator.method62(class215.archive2);
						...
						HitSplatDefinition.field3343 = var16;
