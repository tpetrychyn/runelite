...
public class class14 {
	...
	static void method155(String var0) {
		...
		try {
			String var1 = WorldMapSprite.client.getParameter(class271.field3587.field3597);
			String var2 = WorldMapSprite.client.getParameter(class271.field3594.field3597);
			...
			if (var0.length() == 0) {
				...
				long var6 = DirectByteArrayCopier.currentTimeMillis() + 94608000000L;
