...
public class ScriptFrame {
	...
	static final void updateNpcs(boolean var0, PacketBuffer var1) {
		...
		while (var1.bitsRemaining(Client.packetWriter.serverPacketLength) >= 27) {
			...
			var4.field952 = var4.definition.size;
		...
		for (var2 = 0; var2 < Client.field697; ++var2) {
			...
			if ((var5 & 64) != 0) {
				...
				var8 = var4.x - (var6 - MusicPatchNode2.baseX - MusicPatchNode2.baseX) * 64;
				var9 = var4.y - (var7 - class1.baseY - class1.baseY) * 64;
				if (var8 != 0 || var9 != 0) {
