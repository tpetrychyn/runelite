...
public class class65 extends RouteStrategy {
	...
	public static Sprite SpriteBuffer_getSprite(AbstractArchive var0, int var1, int var2) {
		if (!Friend.method5220(var0, var1, var2)) {
			return null;
		} else {
		...
		while (true) {
			...
			if (var6 != var25) {
				label334: {
					...
					if (var17 == 2 && GrandExchangeOfferWorldComparator.scene.getObjectFlags(class42.Client_plane, var15, var16, var25) >= 0) {
					...
					if (var17 == 3) {
						NodeDeque var33 = Client.groundItems[class42.Client_plane][var15][var16];
						if (var33 != null) {
