...
public class FriendSystem {
	...
	final void processFriendUpdates() {
		for (FriendLoginUpdate var1 = (FriendLoginUpdate)this.friendsList.friendLoginUpdates.last(); var1 != null; var1 = (FriendLoginUpdate)this.friendsList.friendLoginUpdates.previous()) {
			if ((long)var1.field3661 < DirectByteArrayCopier.currentTimeMillis() / 1000L - 5L) {
				if (var1.world > 0) {
	...
	public static int method1784(int var0) {
		return class43.Entity_unpackID(ViewportMouse.ViewportMouse_entityTags[var0]);
	}
			...
			if (var0 == ScriptOpcodes.STOCKMARKET_ISOFFEREMPTY) {
				...
				if (var0 == ScriptOpcodes.TRADINGPOST_SORTBY_NAME) {
					...
					if (var0 == ScriptOpcodes.TRADINGPOST_GETOFFERWORLD) {
						...
						var3 = Interpreter.Interpreter_intStack[--HealthBarUpdate.Interpreter_intStackSize];
						var11 = (GrandExchangeEvent)PendingSpawn.grandExchangeEvents.events.get(var3);
						long var5 = DirectByteArrayCopier.currentTimeMillis() - Buddy.field3632 - var11.age;
