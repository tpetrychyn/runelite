...
final class class4 implements class0 {
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
			...
			if (WorldMapLabelSize.clientPreferences.roofsHidden) {
				...
				label567: {
						...
						label559: {
							...
							if (var9 >= 0 && var10 >= 0 && var9 < 104 && var10 < 104) {
								if (var7 >= 0 && var8 >= 0 && var7 < 104 && var8 < 104) {
									if ((Tiles.Tiles_renderFlags[class42.Client_plane][var9][var10] & 4) != 0) {
										var6 = class42.Client_plane;
									}
					...
					if (Client.localPlayer.x >= 0 && Client.localPlayer.y >= 0 && Client.localPlayer.x < 13312 && Client.localPlayer.y < 13312) {
						if ((Tiles.Tiles_renderFlags[class42.Client_plane][Client.localPlayer.x >> 7][Client.localPlayer.y >> 7] & 4) != 0) {
							var6 = class42.Client_plane;
						}
		...
		if (Client.hintArrowType == 2) {
			class32.worldToScreen((Client.hintArrowX - MusicPatchNode2.baseX << 7) + Client.hintArrowSubX, (Client.hintArrowY - class1.baseY << 7) + Client.hintArrowSubY, Client.hintArrowHeight * 2);
