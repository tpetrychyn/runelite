...
public class class83 {
	...
	static void method1996(int var0, int var1, int var2, ObjectDefinition var3, int var4) {
		...
		var5.field1077 = (var6 + var1) * 128;
		var5.field1082 = (var7 + var2) * 128;
	...
	static int method1994(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.CC_SETSCROLLPOS) {
			...
			if (var0 == ScriptOpcodes.CC_SETMODELANIM) {
				...
				var8 = Interpreter.Interpreter_intStack[--HealthBarUpdate.Interpreter_intStackSize];
				class323 var6 = (class323)SoundSystem.findEnumerated(PcmPlayer.FillMode_values(), var8);
				if (var6 != null) {
					var3.fillMode = var6;
					Strings.invalidateWidget(var3);
				}
	...
	static final int method1995() {
		if (WorldMapLabelSize.clientPreferences.roofsHidden) {
			return class42.Client_plane;
		} else {
			int var0 = ScriptEvent.getTileHeight(PacketBuffer.cameraX, class1.cameraZ, class42.Client_plane);
			return var0 - class43.cameraY < 800 && (Tiles.Tiles_renderFlags[class42.Client_plane][PacketBuffer.cameraX >> 7][class1.cameraZ >> 7] & 4) != 0 ? class42.Client_plane : 3;
		}
	}
}
