...
public class Messages {
	...
	static final void menuAction(int var0, int var1, int var2, int var3, String var4, String var5, int var6, int var7) {
		...
		if (var2 == 1) {
			...
			var8.packetBuffer.method5475(class1.baseY + var1);
			var8.packetBuffer.method5634(WorldMapIcon_1.selectedItemSlot);
			var8.packetBuffer.method5520(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			var8.packetBuffer.method5538(MouseRecorder.selectedItemWidget);
			var8.packetBuffer.method5475(var0 + MusicPatchNode2.baseX);
			var8.packetBuffer.writeShort(var3);
			var8.packetBuffer.method5634(class4.selectedItemId);
			...
			var8.packetBuffer.writeShort(var0 + MusicPatchNode2.baseX);
			var8.packetBuffer.method5530(var3);
			var8.packetBuffer.writeShortLE(WorldMapEvent.selectedSpellWidget);
			var8.packetBuffer.writeShort(Client.selectedSpellChildIndex);
			var8.packetBuffer.method5634(class1.baseY + var1);
			Client.packetWriter.addNode(var8);
		} else if (var2 == 3) {
			Client.mouseCrossX = var6;
			Client.mouseCrossY = var7;
			...
			var8.packetBuffer.writeShort(class1.baseY + var1);
			...
			var8.packetBuffer.method5520(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			var8.packetBuffer.method5530(class1.baseY + var1);
			var8.packetBuffer.method5530(var0 + MusicPatchNode2.baseX);
			var8.packetBuffer.method5634(var3);
			Client.packetWriter.addNode(var8);
		} else {
			...
			if (var2 == 7) {
				...
				if (var13 != null) {
					...
					Client.destinationX = var0;
					Client.destinationY = var1;
					var9 = Archive.getPacketBufferNode(ClientPacket.field2207, Client.packetWriter.isaacCipher);
				...
				if (var13 != null) {
					...
					Client.destinationX = var0;
					Client.destinationY = var1;
					var9 = Archive.getPacketBufferNode(ClientPacket.field2304, Client.packetWriter.isaacCipher);
					var9.packetBuffer.method5475(var3);
					var9.packetBuffer.writeIntME(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
					var9.packetBuffer.method5538(WorldMapEvent.selectedSpellWidget);
					var9.packetBuffer.method5530(Client.selectedSpellChildIndex);
					Client.packetWriter.addNode(var9);
				}
			} else if (var2 == 9) {
				var13 = Client.npcs[var3];
				if (var13 != null) {
					...
					Client.destinationX = var0;
					Client.destinationY = var1;
					var9 = Archive.getPacketBufferNode(ClientPacket.field2274, Client.packetWriter.isaacCipher);
					var9.packetBuffer.writeIntME(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
					var9.packetBuffer.method5634(var3);
					Client.packetWriter.addNode(var9);
				}
			} else if (var2 == 10) {
				var13 = Client.npcs[var3];
				if (var13 != null) {
					...
					Client.destinationX = var0;
					Client.destinationY = var1;
					var9 = Archive.getPacketBufferNode(ClientPacket.field2204, Client.packetWriter.isaacCipher);
				...
				if (var13 != null) {
					...
					Client.destinationX = var0;
					Client.destinationY = var1;
					var9 = Archive.getPacketBufferNode(ClientPacket.field2254, Client.packetWriter.isaacCipher);
					var9.packetBuffer.method5475(var3);
					var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
					Client.packetWriter.addNode(var9);
				}
				...
				if (var13 != null) {
					...
					Client.destinationX = var0;
					Client.destinationY = var1;
					var9 = Archive.getPacketBufferNode(ClientPacket.field2303, Client.packetWriter.isaacCipher);
				...
				if (var13 != null) {
					...
					Client.destinationX = var0;
					Client.destinationY = var1;
					var9 = Archive.getPacketBufferNode(ClientPacket.field2214, Client.packetWriter.isaacCipher);
					var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
					var9.packetBuffer.method5530(var3);
					Client.packetWriter.addNode(var9);
				}
				...
				if (var2 == 14) {
					...
					if (var15 != null) {
						...
						Client.destinationX = var0;
						Client.destinationY = var1;
						var9 = Archive.getPacketBufferNode(ClientPacket.field2284, Client.packetWriter.isaacCipher);
						...
						var9.packetBuffer.method5539(MouseRecorder.selectedItemWidget);
						var9.packetBuffer.writeShort(var3);
					...
					if (var15 != null) {
						...
						Client.destinationX = var0;
						Client.destinationY = var1;
						var9 = Archive.getPacketBufferNode(ClientPacket.field2277, Client.packetWriter.isaacCipher);
						var9.packetBuffer.writeShortLE(WorldMapEvent.selectedSpellWidget);
						var9.packetBuffer.method5502(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
						var9.packetBuffer.method5530(Client.selectedSpellChildIndex);
						var9.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var9);
					...
					var8.packetBuffer.method5539(MouseRecorder.selectedItemWidget);
					...
					var8.packetBuffer.method5539(WorldMapEvent.selectedSpellWidget);
					var8.packetBuffer.writeShort(Client.selectedSpellChildIndex);
					var8.packetBuffer.method5530(class1.baseY + var1);
					var8.packetBuffer.method5530(var0 + MusicPatchNode2.baseX);
					var8.packetBuffer.method5520(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
					...
					var8.packetBuffer.method5475(class1.baseY + var1);
					var8.packetBuffer.method5634(var3);
					var8.packetBuffer.method5634(var0 + MusicPatchNode2.baseX);
					var8.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
					Client.packetWriter.addNode(var8);
				} else if (var2 == 19) {
					Client.mouseCrossX = var6;
					...
					if (Client.isMenuOpen) {
						...
						GrandExchangeOfferWorldComparator.scene.menuOpen(class42.Client_plane, var0, var1, true);
					}
				} else {
					...
					if (var2 == 24) {
						...
						if (var12) {
							var10 = Archive.getPacketBufferNode(ClientPacket.field2272, Client.packetWriter.isaacCipher);
						...
						if (var2 == 25) {
							...
							if (var16 != null) {
								...
								TileItem.selectSpell(var1, var0, HealthBar.method1957(class268.getWidgetClickMask(var16)), var16.itemId);
						...
						if (var2 == 26) {
							...
							if (var2 == 28) {
								...
								if (var14.cs1Instructions != null && var14.cs1Instructions[0][0] == 5) {
									...
									GrandExchangeOfferUnitPriceComparator.changeGameOptions(var11);
								}
							} else if (var2 == 29) {
								var8 = Archive.getPacketBufferNode(ClientPacket.field2272, Client.packetWriter.isaacCipher);
								var8.packetBuffer.writeInt(var1);
								...
								var8.packetBuffer.method5539(var1);
								var8.packetBuffer.writeShortLE(MouseRecorder.selectedItemWidget);
								var8.packetBuffer.method5475(WorldMapIcon_1.selectedItemSlot);
								var8.packetBuffer.method5634(class4.selectedItemId);
								var8.packetBuffer.method5634(var0);
								var8.packetBuffer.method5475(var3);
								Client.packetWriter.addNode(var8);
								Client.field759 = 0;
								...
								var8.packetBuffer.method5634(var3);
								var8.packetBuffer.method5634(Client.selectedSpellChildIndex);
								Client.packetWriter.addNode(var8);
								Client.field759 = 0;
								ItemContainer.field549 = class80.getWidget(var1);
								Client.field698 = var0;
								...
								var8.packetBuffer.method5538(var1);
								var8.packetBuffer.method5475(var0);
								var8.packetBuffer.method5475(var3);
								Client.packetWriter.addNode(var8);
								Client.field759 = 0;
								...
								if (var2 == 38) {
									...
									Client.selectedItemName = ClientPreferences.colorStartTag(16748608) + WorldMapArea.ItemDefinition_get(var3).name + ClientPreferences.colorStartTag(16777215);
								...
								if (var2 == 39) {
									...
									if (var15 != null) {
										...
										Client.destinationX = var0;
										Client.destinationY = var1;
										var9 = Archive.getPacketBufferNode(ClientPacket.field2250, Client.packetWriter.isaacCipher);
										var9.packetBuffer.writeShort(var3);
										var9.packetBuffer.writeIntME(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
										Client.packetWriter.addNode(var9);
									}
									...
									if (var15 != null) {
										...
										Client.destinationX = var0;
										Client.destinationY = var1;
										var9 = Archive.getPacketBufferNode(ClientPacket.field2301, Client.packetWriter.isaacCipher);
										var9.packetBuffer.method5520(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
										var9.packetBuffer.method5530(var3);
										Client.packetWriter.addNode(var9);
									}
									...
									if (var15 != null) {
										...
										Client.destinationX = var0;
										Client.destinationY = var1;
										var9 = Archive.getPacketBufferNode(ClientPacket.field2209, Client.packetWriter.isaacCipher);
										var9.packetBuffer.method5530(var3);
										var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
										Client.packetWriter.addNode(var9);
									}
									...
									if (var15 != null) {
										...
										Client.destinationX = var0;
										Client.destinationY = var1;
										var9 = Archive.getPacketBufferNode(ClientPacket.field2230, Client.packetWriter.isaacCipher);
										var9.packetBuffer.method5475(var3);
										var9.packetBuffer.writeIntME(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
										Client.packetWriter.addNode(var9);
									}
									...
									if (var15 != null) {
										...
										Client.destinationX = var0;
										Client.destinationY = var1;
										var9 = Archive.getPacketBufferNode(ClientPacket.field2241, Client.packetWriter.isaacCipher);
										var9.packetBuffer.method5520(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
										var9.packetBuffer.method5530(var3);
										Client.packetWriter.addNode(var9);
									}
									...
									if (var15 != null) {
										...
										Client.destinationX = var0;
										Client.destinationY = var1;
										var9 = Archive.getPacketBufferNode(ClientPacket.field2257, Client.packetWriter.isaacCipher);
										var9.packetBuffer.method5530(var3);
										var9.packetBuffer.method5502(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
										Client.packetWriter.addNode(var9);
									}
									...
									if (var15 != null) {
										...
										Client.destinationX = var0;
										Client.destinationY = var1;
										var9 = Archive.getPacketBufferNode(ClientPacket.field2278, Client.packetWriter.isaacCipher);
										var9.packetBuffer.method5502(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
										var9.packetBuffer.method5634(var3);
										Client.packetWriter.addNode(var9);
									}
									...
									if (var15 != null) {
										...
										Client.destinationX = var0;
										Client.destinationY = var1;
										var9 = Archive.getPacketBufferNode(ClientPacket.field2253, Client.packetWriter.isaacCipher);
										var9.packetBuffer.writeIntME(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
										var9.packetBuffer.method5475(var3);
										Client.packetWriter.addNode(var9);
									}
									...
									label926: {
										if (var2 != 57) {
											if (var2 == 58) {
												var16 = Client.getWidgetChild(var1, var0);
												if (var16 != null) {
													var9 = Archive.getPacketBufferNode(ClientPacket.field2285, Client.packetWriter.isaacCipher);
													var9.packetBuffer.method5634(Client.selectedSpellChildIndex);
													var9.packetBuffer.writeShortLE(var1);
													var9.packetBuffer.method5634(Client.field812);
											...
											if (var2 == 1003) {
												...
												if (var13 != null) {
													...
													if (var17 != null) {
														var10 = Archive.getPacketBufferNode(ClientPacket.field2233, Client.packetWriter.isaacCipher);
											...
											if (var2 == 1005) {
												...
												if (var16 != null && var16.itemQuantities[var0] >= 100000) {
													...
													var9 = Archive.getPacketBufferNode(ClientPacket.field2227, Client.packetWriter.isaacCipher);
													var9.packetBuffer.method5634(var3);
													Client.packetWriter.addNode(var9);
												}
											...
											if (var2 != 1007) {
												if (var2 == 1008 || var2 == 1009 || var2 == 1011 || var2 == 1010 || var2 == 1012) {
													BoundaryObject.worldMap.worldMapMenuAction(var2, var3, new Coord(var0), new Coord(var1));
												}
												break label926;
											}
										}
										...
										var16 = Client.getWidgetChild(var1, var0);
										if (var16 != null) {
											widgetDefaultMenuAction(var3, var1, var0, var16.itemId, var5);
										}
									}
								}
							}
