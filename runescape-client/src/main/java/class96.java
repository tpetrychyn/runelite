				...
				try {
					...
					for (var10 = 1; var10 < var2.length; ++var10) {
						if (var2[var10] instanceof Integer) {
							...
							if (var11 == -2147483645) {
								var11 = var0.widget != null ? var0.widget.id * 2057858667 * 158584387 : -1;
							}
							...
							if (var11 == -2147483643) {
								var11 = var0.widget != null ? var0.widget.childIndex * -1096893339 * 1544000877 : -1;
							}

							if (var11 == -2147483642) {
								var11 = var0.dragTarget != null ? var0.dragTarget.id * 2057858667 * 158584387 : -1;
							}

							if (var11 == -2147483641) {
								var11 = var0.dragTarget != null ? var0.dragTarget.childIndex * -1096893339 * 1544000877 : -1;
							}
