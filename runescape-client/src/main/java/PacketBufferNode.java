	...
	static final void method3628() {
		...
		if (!var0) {
			...
			for (var1 = 0; var1 < class13.regionLandArchives.length; ++var1) {
				...
				if (var2 != null) {
					var3 = (DirectByteArrayCopier.regions[var1] >> 8) * 64 - MusicPatchNode2.baseX;
					var4 = (DirectByteArrayCopier.regions[var1] & 255) * 64 - class1.baseY;
			...
			if (!var0) {
				...
				if (!Client.isInInstance) {
					...
					for (var49 = 0; var49 < var1; ++var49) {
						var3 = (DirectByteArrayCopier.regions[var49] >> 8) * 64 - MusicPatchNode2.baseX;
						var4 = (DirectByteArrayCopier.regions[var49] & 255) * 64 - class1.baseY;
					...
					for (var49 = 0; var49 < var1; ++var49) {
						...
						if (var53 != null) {
							var4 = (DirectByteArrayCopier.regions[var49] >> 8) * 64 - MusicPatchNode2.baseX;
							var51 = (DirectByteArrayCopier.regions[var49] & 255) * 64 - class1.baseY;
							class186.playPcmPlayers();
				...
				if (var49 > class42.Client_plane) {
					var49 = class42.Client_plane;
				}

				if (var49 < class42.Client_plane - 1) {
					var49 = class42.Client_plane - 1;
				}
