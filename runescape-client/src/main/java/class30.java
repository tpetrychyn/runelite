			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						Client.field817 = 3;
						Client.field818 = var2 ? Interpreter.field1111.id * 2057858667 * 158584387 : Calendar.field2507.id * 2057858667 * 158584387;
						return 1;
					} else {
						boolean var8;
		...
		if (var0 == ScriptOpcodes.FRIEND_COUNT) {
			...
			if (var0 == ScriptOpcodes.FRIEND_GETNAME) {
				...
				if (var0 == ScriptOpcodes.FRIEND_SETRANK) {
					...
					var5 = Interpreter.Interpreter_stringStack[--Skills.Interpreter_stringStackSize];
					var5 = GrandExchangeOfferTotalQuantityComparator.method94(var5);
					...
					Interpreter.Interpreter_intStack[++HealthBarUpdate.Interpreter_intStackSize - 1] = DevicePcmPlayerProvider.clanChat != null ? DevicePcmPlayerProvider.clanChat.rank * 737707483 * 241299027 : 0;
					return 1;
