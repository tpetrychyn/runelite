...
final class class1 implements class0 {
	...
	static final void method10(class185 var0) {
		...
		if (class185.field2320 == var0) {
			...
			if (var7 >= 0 && var8 >= 0 && var7 < 104 && var8 < 104) {
				MusicPatch.updatePendingSpawn(class42.Client_plane, var7, var8, var5, -1, var3, var4, 0, -1);
			}
			...
			if (class185.field2321 == var0) {
				...
				if (var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
					NodeDeque var31 = Client.groundItems[class42.Client_plane][var3][var4];
					if (var31 != null) {
						...
						if (var31.last() == null) {
							Client.groundItems[class42.Client_plane][var3][var4] = null;
						}
				...
				if (class185.field2316 == var0) {
					...
					if (var39 >= 0 && var12 >= 0 && var39 < 104 && var12 < 104 && var14 >= 0 && var41 >= 0 && var14 < 104 && var41 < 104 && var4 != 65535) {
						...
						var14 = var14 * 128 + 64;
						var41 = var41 * 128 + 64;
						Projectile var15 = new Projectile(var4, class42.Client_plane, var39, var12, ScriptEvent.getTileHeight(var39, var12, class42.Client_plane) - var5, var9 + Client.cycle, var3 + Client.cycle, var7, var8, var6, var2);
						var15.setDestination(var14, var41, ScriptEvent.getTileHeight(var14, var41, class42.Client_plane) - var2, var9 + Client.cycle);
					...
					if (var6 >= 0 && var7 >= 0 && var6 < 104 && var7 < 104) {
						NodeDeque var42 = Client.groundItems[class42.Client_plane][var6][var7];
						if (var42 != null) {
					...
					if (var5 >= 0 && var6 >= 0 && var5 < 104 && var6 < 104) {
						...
						var32.id = var3;
						var32.quantity = var2;
						if (Client.groundItems[class42.Client_plane][var5][var6] == null) {
							Client.groundItems[class42.Client_plane][var5][var6] = new NodeDeque();
						}

						Client.groundItems[class42.Client_plane][var5][var6].addFirst(var32);
					...
					if (class185.field2319 == var0) {
						...
						if (var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
							var10 = var7 + 1;
							if (Client.localPlayer.pathX[0] >= var3 - var10 && Client.localPlayer.pathX[0] <= var3 + var10 && Client.localPlayer.pathY[0] >= var4 - var10 && Client.localPlayer.pathY[0] <= var4 + var10 && Client.areaSoundEffectVolume != 0 && var8 > 0 && Client.soundEffectCount < 50) {
					...
					if (class185.field2318 == var0) {
						...
						if (var17 != null) {
							...
							int[][] var25 = Tiles.Tiles_heights[class42.Client_plane];
							...
							if (var29 != null) {
								MusicPatch.updatePendingSpawn(class42.Client_plane, var35, var16, var10, -1, 0, 0, var6 + 1, var3 + 1);
								var17.animationCycleStart = var6 + Client.cycle;
								var17.animationCycleEnd = var3 + Client.cycle;
								var17.model0 = var29;
								var17.field633 = var19 * 64 + var35 * 128;
								var17.field620 = var20 * 64 + var16 * 128;
					...
					if (class185.field2323 == var0) {
						...
						if (var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
							MusicPatch.updatePendingSpawn(class42.Client_plane, var3, var4, var8, var9, var6, var7, 0, -1);
						}
						...
						if (var6 >= 0 && var7 >= 0 && var6 < 104 && var7 < 104) {
							var6 = var6 * 128 + 64;
							var7 = var7 * 128 + 64;
							GraphicsObject var33 = new GraphicsObject(var2, class42.Client_plane, var6, var7, ScriptEvent.getTileHeight(var6, var7, class42.Client_plane) - var3, var4, Client.cycle);
						...
						var4 = var2 & 3;
						var5 = Client.field713[var3];
						var6 = var1.method5524();
						var7 = (var6 >> 4 & 7) + DefaultsGroup.field3819;
						var8 = (var6 & 7) + ChatChannel.field1306;
						var9 = var1.readUnsignedShort();
						if (var7 >= 0 && var8 >= 0 && var7 < 103 && var8 < 103) {
							if (var5 == 0) {
								BoundaryObject var36 = GrandExchangeOfferWorldComparator.scene.method3088(class42.Client_plane, var7, var8);
								if (var36 != null) {
									var39 = class43.Entity_unpackID(var36.tag);
									if (var3 == 2) {
										var36.entity1 = new DynamicObject(var39, 2, var4 + 4, class42.Client_plane, var7, var8, var9, false, var36.entity1);
										var36.entity2 = new DynamicObject(var39, 2, var4 + 1 & 3, class42.Client_plane, var7, var8, var9, false, var36.entity2);
									} else {
										var36.entity1 = new DynamicObject(var39, var3, var4, class42.Client_plane, var7, var8, var9, false, var36.entity1);
									}
								}
							}

							if (var5 == 1) {
								WallDecoration var43 = GrandExchangeOfferWorldComparator.scene.method3118(class42.Client_plane, var7, var8);
								if (var43 != null) {
									var39 = class43.Entity_unpackID(var43.tag);
									if (var3 != 4 && var3 != 5) {
										if (var3 == 6) {
											var43.entity1 = new DynamicObject(var39, 4, var4 + 4, class42.Client_plane, var7, var8, var9, false, var43.entity1);
										} else if (var3 == 7) {
											var43.entity1 = new DynamicObject(var39, 4, (var4 + 2 & 3) + 4, class42.Client_plane, var7, var8, var9, false, var43.entity1);
										} else if (var3 == 8) {
											var43.entity1 = new DynamicObject(var39, 4, var4 + 4, class42.Client_plane, var7, var8, var9, false, var43.entity1);
											var43.entity2 = new DynamicObject(var39, 4, (var4 + 2 & 3) + 4, class42.Client_plane, var7, var8, var9, false, var43.entity2);
										}
									} else {
										var43.entity1 = new DynamicObject(var39, 4, var4, class42.Client_plane, var7, var8, var9, false, var43.entity1);
									}
								}
							}

							if (var5 == 2) {
								GameObject var44 = GrandExchangeOfferWorldComparator.scene.method3195(class42.Client_plane, var7, var8);
								if (var3 == 11) {
									var3 = 10;
								}

								if (var44 != null) {
									var44.entity = new DynamicObject(class43.Entity_unpackID(var44.tag), var3, var4, class42.Client_plane, var7, var8, var9, false, var44.entity);
								}
							}

							if (var5 == 3) {
								FloorDecoration var45 = GrandExchangeOfferWorldComparator.scene.getFloorDecoration(class42.Client_plane, var7, var8);
								if (var45 != null) {
									var45.entity = new DynamicObject(class43.Entity_unpackID(var45.tag), 22, var4, class42.Client_plane, var7, var8, var9, false, var45.entity);
								}
							}
						}
	...
	static boolean method5(int var0) {
