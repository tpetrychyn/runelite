...
public class class42 implements WorldMapSection {
	...
	public int[] getBorderTileLengths(int var1, int var2, int var3) {
		if (!this.containsCoord(var1, var2, var3)) {
			...
			int[] var4 = new int[]{var2 + (this.field366 * 64 - this.field364 * 64) + (this.field370 * 8 - this.field376 * 8), var3 + (this.field375 * 64 - this.field365 * 64) + (this.field371 * 8 - this.field369 * 8)};
			return var4;
		}
	}
	...
	public Coord coord(int var1, int var2) {
		if (!this.containsPosition(var1, var2)) {
			...
			int var4 = var2 + (this.field365 * 64 - this.field375 * 64) + (this.field369 * 8 - this.field371 * 8);
