...
public class WorldMapRegion {
	...
	void method506(int var1, int var2, int var3) {
		Sprite var4 = PlayerType.method4130(this.regionX, this.regionY, this.pixelsPerTile);
		if (var4 != null) {
	...
	void drawTile(int var1, class40 var2, IndexedSprite[] var3, AbstractArchive var4, AbstractArchive var5) {
		...
		if (this.worldMapData_0 != null || !this.worldMapData1List.isEmpty()) {
			if (PlayerType.method4130(this.regionX, this.regionY, var1) == null) {
				boolean var6 = true;
				...
				if (var6) {
					...
					WorldMapRegion_cachedSprites.put(var11, Widget.method4089(var12, var13, var14), var11.pixels.length * 4);
					this.method429();
				}
			}
		}
	...
	public static void playMusicTrack(int var0, AbstractArchive var1, String var2, String var3, int var4, boolean var5) {
		...
		ScriptFrame.musicTrackVolume = var4;
		...
		for (int var1 = 0; var1 < Client.npcCount; ++var1) {
			...
			if (var2 != null && var2.isVisible() && var2.definition.isVisible == var0 && var2.definition.transformIsVisible()) {
				...
				if (var3 >= 0 && var3 < 104 && var4 >= 0 && var4 < 104) {
					if (var2.field952 == 1 && (var2.x & 127) == 64 && (var2.y & 127) == 64) {
					...
					GrandExchangeOfferWorldComparator.scene.drawEntity(class42.Client_plane, var2.x, var2.y, ScriptEvent.getTileHeight(var2.field952 * 64 - 64 + var2.x, var2.field952 * 64 - 64 + var2.y, class42.Client_plane), var2.field952 * 64 - 64 + 60, var2, var2.rotation, var5, var2.isWalking);
				}
			}
		}
