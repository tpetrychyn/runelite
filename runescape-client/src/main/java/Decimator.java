...
public class Decimator {
		...
		if (var0 != null && var0.isVisible()) {
			...
			if (var1 < var75 && var0.playerCycle == Client.cycle) {
				...
				if (var9) {
					...
					if (var1 < var75) {
						class219.method4113(var0, var0.defaultHeight + 15);
				...
				for (HealthBar var88 = (HealthBar)var0.healthBars.last(); var88 != null; var88 = (HealthBar)var0.healthBars.previous()) {
					...
					if (var89 == null) {
						...
						if (var89.cycleOffset > var19) {
							var21 = var91.field3277 == 0 ? 0 : var91.field3277 * (var19 / var91.field3277);
			...
			if (var0.overheadText != null && (var1 >= var75 || !var0.field998 && (Client.publicChatMode == 4 || !var0.isAutoChatting && (Client.publicChatMode == 0 || Client.publicChatMode == 3 || Client.publicChatMode == 1 && ((Player)var0).isFriend())))) {
				class219.method4113(var0, var0.defaultHeight);
			...
			for (int var77 = 0; var77 < 4; ++var77) {
				...
				if (var97 >= 0) {
					...
					var95 = Projectile.method2046(var0.hitSplatTypes[var77]);
				...
				if (var15 >= 0) {
					var81 = Projectile.method2046(var15);
				...
				if (var96 - var98 <= Client.cycle) {
					if (var95 == null) {
						...
						class219.method4113(var0, var0.defaultHeight / 2);
						if (Client.viewportTempX > -1) {
							if (var77 == 1) {
	...
	static void method2510(int var0) {
		...
		Client.tempMenuAction.param0 = Client.menuArguments1[var0];
		Client.tempMenuAction.param1 = Client.menuArguments2[var0];
		Client.tempMenuAction.opcode = Client.menuOpcodes[var0];
		Client.tempMenuAction.identifier = Client.menuIdentifiers[var0];
