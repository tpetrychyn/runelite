...
public class Frames extends DualNode {
	...
	static final boolean method3275(Model var0, int var1, int var2, int var3) {
		...
		if (!var4) {
			...
			if (!ViewportMouse.ViewportMouse_false0) {
				...
				int var15 = Rasterizer3D.method2995(var12, var9, var6, var5);
				var16 = Rasterizer3D.method2996(var12, var9, var6, var5);
				var12 = var15;
				var15 = Rasterizer3D.method2995(var14, var10, var6, var5);
				var17 = Rasterizer3D.method2996(var14, var10, var6, var5);
				var14 = var15;
				var15 = Rasterizer3D.method2982(var11, var16, var8, var7);
				var16 = Rasterizer3D.method2994(var11, var16, var8, var7);
				var11 = var15;
				var15 = Rasterizer3D.method2982(var13, var17, var8, var7);
				var17 = Rasterizer3D.method2994(var13, var17, var8, var7);
			...
			if (Math.abs(var11) > var8 + ScriptFrame.field527) {
				...
				return false;
			} else if (Math.abs(var11 * Canvas.field422 - var13 * TileItem.field1242) > var8 * MenuAction.field1160 + var17 * ScriptFrame.field527) {
				return false;
			} else {
